...
Route::get('/getPlayerTypeById/{id}', 'App\Http\Controllers\PlayerTypeController@getPlayerTypeById');
...
Route::get('/getTeamById/{id}', 'App\Http\Controllers\TeamController@getTeamById');
...
Route::get('/getPlayerById/{id}', 'App\Http\Controllers\PlayerController@getPlayerById');
...
Route::post('/deleteImage/{id}', 'App\Http\Controllers\PlayerController@deleteImage');
